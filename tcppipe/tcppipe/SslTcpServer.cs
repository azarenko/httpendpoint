...
namespace tcppipe
{
    internal sealed class SslTcpServer
    {
        private X509Certificate serverCertificate = null;
        private string outcommingIP;
        private int outcommingPort;
        ...
        {
            TcpListener listener = new TcpListener(IPAddress.Any, incommingPort);
            listener.Start();
        ...
        private void ProcessSslClient(TcpClient client)
        {
